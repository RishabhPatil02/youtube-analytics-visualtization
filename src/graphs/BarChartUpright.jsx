...
const BarChartUpright = ({ xData, yData, variable }) => {
  const svgRef = useRef();
  ...
  useEffect(() => {
    ...
    newSvg.selectAll('.bar')
      ...
      .duration(1000)
      .delay((d, i) => i * 100)
      .attr('y', (d, i) => yScale(adjustedYData[i]))
      .attr('height', (d, i) => height - yScale(adjustedYData[i]));
...
export default BarChartUpright;
